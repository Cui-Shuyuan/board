...
namespace BoardGameTutorial
{
    public static class Palette
    {
        private static readonly Dictionary<string, Color> Colors = new Dictionary<string, Color>
        {
            ...
            { "panel_neutral", new Color(0.85f, 0.88f, 0.92f) },
            { "accent_green", new Color(0.24f, 0.72f, 0.38f) },
            { "accent_yellow", new Color(0.95f, 0.80f, 0.24f) },
            { "accent_blue", new Color(0.30f, 0.55f, 0.95f) },
