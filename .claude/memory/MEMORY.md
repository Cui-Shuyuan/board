...
- [教学动画数据层](tutorial-data-layer.md) — 旧 tutorial.json 路线已退役；现为 v2 full.anim.json + compiler + compiled + Unity 薄运行时（2026-09-21）
- [讲规动画制作路线](tutorial-production-pipeline.md) — 口播稿主/动画从；Splendor v2 全量 109 cue 已完成编译/规则过账/Unity 采样对账；生产闭环已更新到 v2（2026-09-21）
- [讲规动画状态模型](tutorial-animation-state.md) — 已加【最终·v2】；动画=时间的纯函数，编译期算入口快照/slot/camera，旧 v1 god class 已删除（2026-09-21）
