...
- **背景设定（`<ontology::setting>`）**：《文明演化》的世界观。玩家是创世技术学院的学生，正在参加名为「文明演化」的考试；考试场地是一片僻静的大陆，每位考生要成为当地神祇、发展引领自己的文明并与其他文明竞争，胜者晋升为学院正式成员。阿格拉（Agera）是考试主考官，`<favor_of_ager_track>` 表示考生获得阿格拉恩惠的程度。
