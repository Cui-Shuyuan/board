# -*- coding: utf-8 -*-
"""调试 Q21 复测：查看 plan 与 execute_plan 结果。"""
import json
import re
import sys

LOG = r"D:\Temp\claude\D--workspace-board\04b87d4b-f215-47f7-9e52-78a411e99c01\tasks\bye69q95w.output"
    ...
    if "何时触发" in q:
        ...
        for rm in re.finditer(r"Tool execute_plan result:\s*", text):
            ...
            if j:
                ...
                if res.get("List"):
                    print(" LIST:", [str(x)[:70] for x in res["List"][:10]])
